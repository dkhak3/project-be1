...
if(isset($_POST['username']) && isset($_POST['password_confirmation']))
{
  ...
  if(!$check)
  {
    $accountModel->registerUser($userName, $password);
    $userModel = new UserModel();
    $userModel->addInfoUser($userName, $fullName, $email);
...
<body>
  <div class="main">
    <form action="formUp.php" method="POST" class="form" id="form-1">
