                                                    ...
                                                    <li class="header__cart-item">
                                                        ...
                                                        <div class="header__cart-item-info">
                                                            ...
                                                            <div class="header__cart-item-body">
                                                                ...
                                                                <a href="userproduct.php?idDeleteProduct=<?php echo $element['id'] ?>" class="header__cart-item-remove">Delete
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </li>
                ...
                <div class="product-content">
                    ...
                    <div class="product-form-submit">
                        <div class="product-form-add">
                            <a href="userproduct.php?idAddProduct=<?php echo $id ?>" class="btn product-form__cart-submit">
