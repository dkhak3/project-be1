...
if (isset($_POST['accountName']) && isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $check = false;
    foreach ($accountModel->getAllUsernameByAdmin() as $item) {
        if ($adminAccountName == $item['username']) {
            $check = true;
            break;
        }
    }
    ...
    if ($check) {
        ...
        if ($adminModel->getInfoAdminByUsername($adminAccountName)['email'] == $adminEmail) {
            $accountModel->changePasswordForAdmin($adminAccountName, $adminPassword);
        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <form action="adminforgotpassword.php" method="post" id="form-1">
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="accountName" name="accountName" placeholder="duykha2k3">
