...
if (isset($_SESSION['category_usercategory'])) unset($_SESSION['category_usercategory']);
if (isset($_SESSION['qtyProductInRow_usercategory'])) unset($_SESSION['qtyProductInRow_usercategory']);
if (isset($_SESSION['categorySort_user'])) unset($_SESSION['categorySort_user']);
                                                    ...
                                                    <li class="header__cart-item">
                                                        ...
                                                        <div class="header__cart-item-info">
                                                            ...
                                                            <div class="header__cart-item-body">
                                                                ...
                                                                <a href="usersearch.php?idDeleteProduct=<?php echo $element['id'] ?>" class="header__cart-item-remove">Delete
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </li>
                        ...
                        <div class="product-menu">
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    ?>
                                        <a href="usersearch.php?quantityProductInRow=2" class="btn-view btn-view-2 active"></a>
                                    ...
                                    ?>
                                        ...
                                        <a href="usersearch.php?quantityProductInRow=3" class="btn-view btn-view-3 active"></a>
                                        <a href="usersearch.php?quantityProductInRow=4" class="btn-view btn-view-4"></a>
                                    <?php
                                    ...
                                    ?>
                                        <a href="usersearch.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                                        <a href="usersearch.php?quantityProductInRow=3" class="btn-view btn-view-3"></a>
                                        <a href="usersearch.php?quantityProductInRow=4" class="btn-view btn-view-4 active"></a>
                                    <?php
                                    } else {
                                    ?>
                                        <a href="usersearch.php?quantityProductInRow=2" class="btn-view btn-view-2"></a>
                                ...
                                <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <li><a class="dropdown-item" href="usersearch.php?sort=5">None <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                                        <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
                                                    </svg></a></li>
                                            <li><a class="dropdown-item" href="usersearch.php?sort=1">Price: low to hight <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                                                    </svg></a></li>
                                            <li><a class="dropdown-item" href="usersearch.php?sort=2">Price: hight to low <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
                                                    </svg></a></li>
                                            <li><a class="dropdown-item" href="usersearch.php?sort=3">Star: low to hight <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z" />
                                                    </svg></a></li>
                                            <li><a class="dropdown-item" href="usersearch.php?sort=4">Star: hight to low <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z" />
                                                    </svg></a></li>
                                        </ul>
                                    </div>
